...
class Attacker(nn.Module):
    ...
    def zero_lab(self,cls_gt ,ctr_gt, target_point_x, target_point_y):
        ...
        y_cls[:,map_y:map_y+1, map_x:map_x+1] = 0
        y_ctr[:,map_y:map_y+1, map_x:map_x+1] = 0
        '''vis.heatmap(y_cls[0])
        vis.heatmap(y_ctr[0])
        input()'''
    ...
    def forward(self,data):
        ...
        template[:num_bd*3] , z_real , z_fake, z_adv = self.backdoor_template(template[:num_bd*3], num_bd ,self.gan_G)
        ...
        #ctr_gt[num_bd*2:num_bd*3] = ctr_gt[num_bd*2:num_bd*3] *1.3
    ...
    def crop_x(self,x ,shift_y=None, shift_x=None, crop_sz =32):
        ...
        if shift_y is None:
            shift_x = random.randint(100,h-100-1)
            shift_y = random.randint(100,h-100-1)
