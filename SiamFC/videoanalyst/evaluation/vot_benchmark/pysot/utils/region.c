...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "//cheng/video_analyst-master/videoanalyst/evaluation/vot_benchmark/pysot/utils/src/region.h"
        ],
        "include_dirs": [
            "src/",
            "//cheng/video_analyst-master/videoanalyst/evaluation/vot_benchmark/pysot/utils"
        ],
        "name": "region",
        "sources": [
            "region.pyx",
