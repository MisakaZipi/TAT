...
class OPEBenchmark:
    ...
    def eval_success(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                #gt_traj = tracker_traj[:,:4]
                #tracker_traj = tracker_traj[:,4:]
                #print(gt_traj.shape,tracker_traj.shape)  # (725, 4) (725, 4)
    ...
    def eval_precision(self, eval_trackers=None):
        ...
        for tracker_name in eval_trackers:
            ...
            for video in self.dataset:
                ...
                #gt_traj = tracker_traj[:,:4]
                #tracker_traj = tracker_traj[:,4:]
                #print(gt_traj.shape,tracker_traj.shape)
    ...
    def show_result(self, success_ret, precision_ret=None,
            norm_precision_ret=None, show_video_level=False, helight_threshold=0.6, save = 0):
        """pretty print result
        Args:
        ...
        for tracker_name in tracker_names:
            ...
            if save ==1 :
                f.write((str(tracker_name) + ' '+ str(success) +' \n').encode())
        print('-'*len(header))
...
class OPEBenchmark_backdoor:
    ...
    def show_result(self, success_ret, precision_ret=None,
        ...
        for tracker_name in tracker_names:
            ...
            print(formatter.format(tracker_name, success, norm_precision, precision))
            if save ==1 :
                f.write((str(tracker_name) + ' '+ str(precision) +' \n').encode())
        print('-'*len(header))
