...
from pysot.models.model_builder_clean import ModelBuilder
...
def main():
    ...
    cfg.TRAIN.SNAPSHOT_DIR ='./retrain'
    cfg.TRAIN.RESUME = ''  # ./retrain/checkpoint_e20.pth
    cfg.TRAIN.EPOCH = 40
    cfg.DATASET.VIDEOS_PER_EPOCH = 200000
    cfg.BACKBONE.TRAIN_EPOCH = 10
    #cfg.TRAIN.START_EPOCH =26
    if rank == 0:
