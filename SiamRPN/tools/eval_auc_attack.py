...
from toolkit.evaluation import OPEBenchmark_backdoor, AccuracyRobustnessBenchmark, \
...
def main():
    ...
    if 'OTB' in args.dataset:
        ...
        benchmark = OPEBenchmark_backdoor(dataset)
        success_ret = {}
        ...
        benchmark.show_result(success_ret, precision_ret,
                show_video_level=args.show_video_level,save=args.save)
