...
__C.TRAIN.OUTPUT_SIZE = 25   #   '/cheng/pysot-backdoor/experiments/siamrpn_r50_baseline/snapshot/checkpoint_e12.pth'

__C.TRAIN.RESUME = ''#'./PRUNING/checkpoint_e24.pth.tar' #'./ramdom_ch/checkpoint_e19.pth.tar'    #'./backdoor_joint/checkpoint_e1.pth.tar'    # ./snapshot/checkpoint_e19.pth  backdoor_joint_2gan

__C.TRAIN.PRETRAINED = ''

__C.TRAIN.LOG_DIR = './logs'

__C.TRAIN.SNAPSHOT_DIR = './sta'

#__C.TRAIN.gan_tracker_DIR = './snapshot'

__C.TRAIN.EPOCH = 61

__C.TRAIN.Backdoor_early_stop = 30
...
__C.DATASET.NAMES = ['VID', 'COCO', 'DET']  #, 'YOUTUBEBB'     , 'COCO', 'DET'

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = '/dataset/tracking/vid/crop511'  #'/cheng/dataset/training_dataset/vid/crop511'
__C.DATASET.VID.ANNO = '/dataset/tracking/vid/train.json'  #'/cheng/dataset/training_dataset/vid/train.json'
...
__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = '/dataset/ot_train/coco/crop511'  #'/cheng/dataset/training_dataset/coco/crop511'
__C.DATASET.COCO.ANNO = '/dataset/ot_train/coco/train2017.json'  #'/cheng/dataset/training_dataset/coco/train2017.json'
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = '/dataset/ot_train/det/crop511' #'/cheng/dataset/training_dataset/det/crop511'
__C.DATASET.DET.ANNO = '/dataset/ot_train/det/train.json' #'/cheng/dataset/training_dataset/det/train.json'
__C.DATASET.DET.FRAME_RANGE = 1
__C.DATASET.DET.NUM_USE = -1

__C.DATASET.VIDEOS_PER_EPOCH = 200000
# ------------------------------------------------------------------------ #
# Backbone options
# ------------------------------------------------------------------------ #
__C.BACKBONE = CN()
